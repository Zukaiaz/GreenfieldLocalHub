...
namespace GreenFieldLocalHub.Controllers
{
    public class OrderProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("OrderProductsId,OrdersId,ProductsId,ProductsQuantity")] OrderProducts orderProducts)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderProductsId,OrdersId,ProductsId,ProductsQuantity")] OrderProducts orderProducts)
        {
